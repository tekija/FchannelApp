function baselayers(map, feature_group_Under110kVLines,feature_group_150kVand110kVLines,feature_group_220kVLines,
    ...
    var vsLayer = L.tileLayer.wms(sapoWMS, {
        layers: 'eig:wspd',
        format: 'image/png',
        transparent: true,
        format_options: 'layout:message',
    ...
    var vbLayer = L.tileLayer.wms(sapoWMS, {
        layers: 'eig:wbarbs',
        format: 'image/png',
        transparent: true,
        format_options: 'layout:message',
    ...
    var proxy = 'server/proxy.php';
    var vbTimeLayer = L.timeDimension.layer.wms(vbLayer, {
        proxy: proxy,
        updateTimeDimension: true
    });
...
L.TimeDimension.Layer.TileLayer.Portus = L.TimeDimension.Layer.TileLayer.extend({
    ...
    L.timeDimension.layer.tileLayer.portus = function(layer, options) {
        return new L.TimeDimension.Layer.TileLayer.Portus(layer, options);
                ...
                var cldLejer=L.tileLayer('https://farcross.weather2umbrella.com/europan/w_jsons/png/{d}/{h}/cld/{z}/{x}/{y}.png', {
                });
                var cldTimeLayer = L.timeDimension.layer.tileLayer.portus(cldLejer, {});
                var t2mLejer=L.tileLayer('https://farcross.weather2umbrella.com/europan/w_jsons/png/{d}/{h}/tmp2m/{z}/{x}/{y}.png', {
                });
                var tpm2mTimeLayer = L.timeDimension.layer.tileLayer.portus(t2mLejer, {});
                var pcpLejer=L.tileLayer('https://farcross.weather2umbrella.com/europan/w_jsons/png/{d}/{h}/pcp/{z}/{x}/{y}.png', {
                });
                var pcpTimeLayer = L.timeDimension.layer.tileLayer.portus(pcpLejer, {});
                var tmp850Lejer=L.tileLayer('https://farcross.weather2umbrella.com/europan/w_jsons/png/{d}/{h}/tmp850mb/{z}/{x}/{y}.png', {
                });
                var tmp850TimeLayer = L.timeDimension.layer.tileLayer.portus(tmp850Lejer, {});
                ...
                overlayMaps[getI18n('W2U clouds-WMS', localLang)]= sapoHeightTimeLayer;
                ...
                overlayMaps[getI18n('W2U wbarbs-WMS', localLang)]=vbTimeLayer
                overlayMaps[getI18n('W2U cld-tile', localLang)]=cldTimeLayer
                overlayMaps[getI18n('W2U t2m-tile', localLang)]=tpm2mTimeLayer
                overlayMaps[getI18n('W2U pcp-tile', localLang)]=pcpTimeLayer
                overlayMaps[getI18n('W2U t850mb-tile', localLang)]=tmp850TimeLayer
